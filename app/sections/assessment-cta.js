          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
            ...
            <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-6">
              <motion.div
                ...
                className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-xl hover:border-[#9f0202]/20 transition-all group"
              >
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-2">Pay-ally P2P</h3>
                <p className="text-gray-500 text-xs mb-6 leading-relaxed">
                  Evaluate procurement lifecycle and payment efficiency.
                </p>
                <Link href="/assessment?type=payally">
